...
public class TestLogParser {
    ...
    private final Set<String> lowEndDateIps = new HashSet<>();
    private final Set<String> highEndDateIps = new HashSet<>();
    private final Set<String> betweenEndDateIps = new HashSet<>();
